...
contract CreatePoolAndAddLiquidityScript is BaseScript, LiquidityHelpers {
    ...
    // ETH is worth $2500 USDC for initial liquidity provisioning
    uint256 public token0Amount = 1e19; // 10 ETH (ETH has decimals 18)
    uint256 public token1Amount = 25e10; // $250,000 USDC (USDC has decimals 6)
