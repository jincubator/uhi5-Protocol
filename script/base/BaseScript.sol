...
contract BaseScript is Script {
    ...
    IERC20 internal constant token1 = IERC20(0x078D782b760474a361dDA0AF3839290b0EF57AD6); //USDC on Unichain
    // IERC20 internal constant token1 = IERC20(0x9151434b16b9763660705744891fA906F660EcC5); //USDT0 on Unichain
    // IHooks constant hookContract = IHooks(address(0));
    IHooks constant hookContract = IHooks(address(0x8a62f3271d105a0fAB385CD51c5eC068b12dcac0));
    address constant ourAddress = address(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
    uint24 lpFee = 5000; // 0.50%  if not usinng hook contract use 0.4329% for uniqueness when testing on forks
    int24 tickSpacing = 100;
    // test poolKey 0xde57f5089316fb8bed6653d7bf5177933d19a91ed273f424533caf37fe0f1cc6
    /////////////////////////////////////
